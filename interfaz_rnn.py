...
import numpy as np
import joblib
import base64  # ← NECESARIO para mostrar imágenes con base64
    ...
    with open("img1.jpg", "rb") as image_file:
        ...
        st.markdown(
            ...
            <div style="text-align:center;">
                ...
                <p><b>Evaluación del estado nutricional de gestantes</b></p>
            </div>
            """,
            unsafe_allow_html=True
        )
except:
    st.warning("No se encontró la imagen 'img1.jpg'")
...
try:
    ...
    st.error("El modelo no contiene información sobre las columnas usadas en el entrenamiento.")
    st.stop()
...
show_roc = st.sidebar.checkbox("📈 Mostrar curva ROC")
...
# Activar la dummy correspondiente a la provincia si está presente
...
# === Control de predicción persistente ===
...
if "prediction" in st.session_state and "probabilities" in st.session_state:
    ...
    st.subheader(f"📌 Diagnóstico predicho: **{pred}**")
    try:
        ...
        st.info("Puedes agregar imágenes como 'Déficit.jpg', 'Normal.jpg' o 'Sobrepeso.jpg'.")
...
if show_sample:
    st.subheader("📋 Mostrar muestra del dataset")
...
# 4. Curva ROC
if show_roc:
    st.subheader("📈 Curva ROC por clase")
